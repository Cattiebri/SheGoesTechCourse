...
//		createByUser();
		Muggles harrry = new Muggles("Harry", "school", true);
		System.out.println(harrry.sortRandomTower());
		System.out.println(harrry.info());
...
//		scanner.close();
//		Muggles creation = new Muggles(inputName, inputLocation, isWizard);
//		return creation;
//	}
